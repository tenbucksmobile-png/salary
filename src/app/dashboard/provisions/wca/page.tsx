...
// WCA reconciliation is being built hotel by hotel. IH first — ILRB and APA
// get their own separate reconciliations later (same schema, own data),
// so this list grows one short_code at a time rather than sharing IH's data.
const WCA_HOTEL_CODES = ['IH'];
    ...
    <div className="p-8">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground text-sm mt-1">
          One consolidated row per year summarising the Compensation Fund statement of account. Reconciliation captures what the company has done that the Fund hasn't reflected yet — payments not posted, disputes raised, discrepancies. Being built hotel by hotel — IH only for now.
        </p>
      </div>
